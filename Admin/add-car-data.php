...
if (isset($_POST['btn'])) {
    ...
    if (in_array($path, $format)) {
        ...
        if (move_uploaded_file($tmp, "../images/" . $newpath)) {
            $sql = "INSERT INTO `car_details` SET `name`='$name',`price`=$price,`class`='$class',`luggage`='$luggage',`passengers`='$passenger',`img`='$newpath'";
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="col-md-12 mt-3">
                                ...
                                <input type="text" name="name" class="form-control fs-4" placeholder="Enter Car Name Here" required>
                            </div>
                            <div class="col-md-6 mt-3">
                                <label for="car_name">Passenger Capacity</label>
                                <input type="text" name="passenger" class="form-control fs-4" placeholder="Enter Car Passenger Capacity Here" required>
                            </div>
                            <div class="col-md-6 mt-3">
                                <label for="car_name">Car Price</label>
                                <input type="number" name="price" class="form-control fs-4" placeholder="Enter Car Price Here" required>
                            </div>
                            <div class="col-md-12 mt-3">
                                <label for="car_name">Car Class</label>
                                <input type="text" name="class" class="form-control fs-4" placeholder="Enter Car Class Here" required>
                            </div>
                            <div class="col-md-12 mt-3">
                                <label for="car_name">Luggage Capacity</label>
                                <input type="text" name="luggage" class="form-control fs-4" placeholder="Enter Luggage Capacity Here" required>
                            </div>
                            <div class="col-md-12 mt-3">
                                <label for="car_name">Car Image</label>
                                <input type="file" name="image" class="form-control fs-4" placeholder="Enter Car Name Here" required>
                            </div>
                            <div class="col-md-12 mt-3">
                                <input type="submit" name="btn" class="form-control btn btn-outline-primary fs-4 an_btn rounded" placeholder="Submit" required>
                            </div>
                        </div>
                    </form>
                </div>
