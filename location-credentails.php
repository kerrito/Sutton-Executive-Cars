...
$sql="INSERT INTO location_credential SET `id`=$id,`pickup_loc`='$pickup_loc',`pickup_time`='$pickup_time',`pickup_date`='$pickup_date',`drop_loc`='$drop_location',`drop_time`='$drop_time',`drop_date`='$drop_date',`via_loc`='$via_location'";
